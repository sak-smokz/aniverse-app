...
import 'Merchant_view_dress.dart';
import 'production_updateprofile.dart';
import 'production_view_event_booking.dart';
...
class production_navigationscreen extends StatelessWidget {
  const production_navigationscreen({Key? key}) : super(key: key);
  ...
  Future<List<Map<String, dynamic>>> _loadProfile(BuildContext context) async {
    try {
      ...
      String categoryUrl = '$ip/api/production_view_profile';
                    ...
                    children: [
                      _buildListItem(
                        ...
                        onTap: () async {
                          bool? updated = await Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => productionUpdateProfileScreen(profile: profile)),
                          );
                          if (updated == true) {
                      ...
                      _buildListItem(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => prod_viewOrderDressScreen()),
                          );
                        },
                      ),
                      _buildListItem(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => prod_viewOrderEventScreen()),
                          );
                        },
                      ),
                      _buildListItem(
