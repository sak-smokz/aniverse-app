...
class prod_viewOrderEventScreen extends StatefulWidget {
  const prod_viewOrderEventScreen({Key? key}) : super(key: key);

  @override
  _prod_viewOrderEventScreenState createState() => _prod_viewOrderEventScreenState();
}

class _prod_viewOrderEventScreenState extends State<prod_viewOrderEventScreen> {
  Future<List<Map<String, dynamic>>> _fetchOrders() async {
    try {
      final prefs = await SharedPreferences.getInstance();
      String userId = prefs.getString("lid") ?? "";
      String ip = prefs.getString("ip") ?? "";
      String apiUrl = "$ip/api/prod_view_eventbook";
